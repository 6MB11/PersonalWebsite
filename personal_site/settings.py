...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '0.0.0.0', 'personal-site-mb.fly.dev', '.markobuha.ca']
...
STATICFILES_STORAGE = 'whitenoise.storage.CompressedStaticFilesStorage'  # <-- Updated!
