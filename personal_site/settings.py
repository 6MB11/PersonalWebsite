...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'personal-site-aged-glitter-7640.fly.dev', '.markobuha.ca']

CSRF_TRUSTED_ORIGINS = ['https://personal-site-aged-glitter-7640.fly.dev', 'https://*.markobuha.ca']  # <-- Updated!
